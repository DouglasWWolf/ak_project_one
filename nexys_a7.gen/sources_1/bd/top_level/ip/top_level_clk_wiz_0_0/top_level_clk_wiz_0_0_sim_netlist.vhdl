...
-- Date        : Mon Jan 22 16:12:06 2024
-- Host        : simtool-5 running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /fpga/ak_project/nexys_a7.gen/sources_1/bd/top_level/ip/top_level_clk_wiz_0_0/top_level_clk_wiz_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of top_level_clk_wiz_0_0_clk_wiz is
  ...
  signal clk_100mhz_top_level_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_100mhz_top_level_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_100mhz,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_100mhz_top_level_clk_wiz_0_0_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_100mhz_top_level_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
